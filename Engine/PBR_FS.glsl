...
uniform sampler2D tex_metalness1;
...
{		
    ...
    float metallic  = texture(tex_metalness1, texCoord).r;
    float roughness = texture(tex_specular1, texCoord).r;
    float ao        = texture(tex_ao1, texCoord).r;
